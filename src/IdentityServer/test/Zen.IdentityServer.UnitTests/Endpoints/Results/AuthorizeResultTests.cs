...
using Zen.IdentityServer.Endpoints.Results;
...
public class AuthorizeResultTests
{
    ...
    private MockMessageStore<Zen.IdentityServer.Models.ErrorMessage> _mockErrorMessageStore = new MockMessageStore<Zen.IdentityServer.Models.ErrorMessage>();
