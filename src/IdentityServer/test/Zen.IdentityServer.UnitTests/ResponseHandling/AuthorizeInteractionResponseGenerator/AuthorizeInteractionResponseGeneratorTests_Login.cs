...
public class AuthorizeInteractionResponseGeneratorTests_Login
{
    ...
    private Zen.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
    ...
    {
        _subject = new Zen.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator(
            _clock,
