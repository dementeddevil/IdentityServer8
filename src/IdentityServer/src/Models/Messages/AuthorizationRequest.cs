...
public class AuthorizationRequest
{
    ...
    /// <summary>
    /// The expected domain the user will use to login. This is requested from the client
    /// via the <c>domain_hint</c> parameter on the authorize request.
    /// </summary>
    /// <value>
    /// The domain hint.
    /// </value>
    /// <remarks>
    /// This value is available to support automatic redirection to external identity providers
    /// based on a mapping of suitable domains.
    /// </remarks>
