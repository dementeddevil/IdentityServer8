...
using Zen.IdentityServer.Configuration.DependencyInjection;
using Zen.IdentityServer.Endpoints;
using Zen.IdentityServer.Events;
using Zen.IdentityServer.Extensions;
using Zen.IdentityServer.Hosting;
using Zen.IdentityServer.Hosting.FederatedSignOut;
...
public static class IdentityServerBuilderExtensionsCore
{
        ...
        where T : class, IEndpointHandler
    {
        ...
        builder.Services.AddSingleton(new Zen.IdentityServer.Hosting.Endpoint(name, path, typeof(T)));
