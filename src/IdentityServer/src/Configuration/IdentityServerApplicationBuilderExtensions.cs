...
public static class IdentityServerApplicationBuilderExtensions
{
    ...
    internal static void Validate(this IApplicationBuilder app)
    {
        ...
        var logger = loggerFactory.CreateLogger("Zen.IdentityServer.Startup");
        logger.LogInformation("Starting Zen.IdentityServer version {version}", typeof(Zen.IdentityServer.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>()!.InformationalVersion);
