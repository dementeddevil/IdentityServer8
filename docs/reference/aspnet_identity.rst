...
The repo for this support is located `here <https://github.com/dementeddevil/Zen.IdentityServer.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/Zen.IdentityServer.AspNetIdentity>`_.
