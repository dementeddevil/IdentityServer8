Welcome to Zen.IdentityServer (latest)
=============================================

.. image:: images/logo.png
   :align: center

Zen.IdentityServer is an OpenID Connect and OAuth 2.0 framework for ASP.NET Core.
...
.. warning:: 
   ...
   Zen.IdentityServer will be maintained with security updates until November 2022. 
