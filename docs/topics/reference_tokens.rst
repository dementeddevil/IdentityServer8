...
or use the `identity server authentication handler <https://github.com/IdentityServer/Zen.IdentityServer.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
