iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/IdentityServer/Zen.IdentityServer.Quickstart.UI.AspNetIdentity/main/getmain.ps1'))	
